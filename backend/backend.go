...
type Operation struct {
	...
	//
	// ModulePath specifies a filesystem path to load the module. This could
	// be blank if the backend supports it.
	//
	// ModuleUpload specifies whether the module source should be uploaded
	// to a remote provider. Setting this to true may be an error for some
	// backends.
	ModulePath   string
	ModuleUpload bool
